...
class SendMessage extends Component {
    ...
    sendMessage() {
        ...
        let messageDto = JSON.stringify({ user: this.props.thisUser, data: this.state.inputValue, type: MessageType.TEXT_MESSAGE, tourID : parseInt(localStorage.getItem('tourID'))});
