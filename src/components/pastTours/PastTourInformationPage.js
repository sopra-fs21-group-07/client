...
class PastTourInformationPage extends React.Component {
...
/*     chooseRandomNumber(tourListLength) {
    ...
    async componentDidMount() {
        try {
            ...
            alert(`Something went wrong while fetching the Tours: \n${handleError(error)}`);
        }
    }
                        ...
                        <TourStyle>
                            ...
                            <TourContainer>
                                ...
                                <Image cloudName="sopra-group-7" publicID= {this.state.tourList[0].tourPictureKey}
                                       ...
                                       onClick={() => {
                                           this.openTourProfile(this.state.tourList[0].id);//müsste summit sein, nicht ID
...
export default withRouter(PastTourInformationPage);
